...
public sealed class SystemTravelVisualController : MonoBehaviour
{
    [Header("Views")]
    [SerializeField] private TravelLineView travelLineView;
    [SerializeField] private ShipEngineGlowView engineGlowView;
    ...
    private void UpdateTravelLine()
    {
        ...
        Vector2 from = state.GetCurrentPosition();
        Vector2 to = _travelService.GetCurrentDestinationPosition();
    ...
    private void UpdateEngineGlow()
    {
        ...
        Vector2 current = state.GetCurrentPosition();
        Vector2 movementDirection = current - _lastShipPosition;
